...
const buttonVariants = cva("inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0", {
    variants: {
        variant: {
            ...
            whatsapp: "border-2 border-whatsapp/80 bg-transparent text-whatsapp hover:bg-whatsapp hover:text-white shadow-sm hover:shadow-md transition-all duration-300 font-bold tracking-wide",
            hero: "bg-accent text-accent-foreground hover:bg-accent/90 shadow-glow hover:shadow-glow font-bold text-base",
